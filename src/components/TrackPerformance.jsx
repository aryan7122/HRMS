...
import '../styles/TrackPerformance.css';
...
const TrackPerformance = ({ setIsLoggedIn }) => {
    ...
    <div className="login-container">
      ...
      <div className="login-image">
        ...
        <div className="overlay-text">
          <p className="access-info">Track Performance</p>
          <p className="details-info">Access employee performance reviews, set  </p>
          <p className='details-info1'>
          goals, and monitor employee progress.
          </p>
        </div>
