                        ...
                        <div className="from1">
                            <div className="form-group">
                                ...
                                <div className="dropdown">
                                    <div className="dropdown-button" ref={TrainingButtonRef} onClick={toggleTraining}>
                                        <div className='divselect'>{formData.training || "Select Training Name"}</div>
                                        <span id="toggle_selectIcon">
                                            {!isTrainingOpen ? <IoIosArrowDown /> : <IoIosArrowUp />}
                                        </span>
                                    </div>
                                    {isTrainingOpen && (
                                        <div className="dropdown-menu" ref={TrainingRef}>
                                            <input
                                                type="search"
                                                className="search22"
                                            ...
                                            <div className="dropdown_I">
                                                {departmentHead.filter(option =>
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() => selectOption('training', option)}
                                                        key={option.user_id}
                                                    >
                            ...
                            {/* Leave Type Dropdown */}
                            <div className="form-group">
                                <label className='starred'>Trainer Asssigned</label>
                                <div className="dropdown">
                                    <div className="dropdown-button" ref={leaveTypeButtonRef} onClick={toggleLeaveType}>
                                        <div>{formData.leaveType || "Select Trainer Asssigned"}</div>
                                    ...
                                    {isLeaveTypeOpen && (
                                        <div className="dropdown-menu" ref={leaveTypeRef}>
                                            <input
                                                type="search"
                                                className='search22'
                                                placeholder="Search Trainer Asssigned"
