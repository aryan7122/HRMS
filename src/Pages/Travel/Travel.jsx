                ...
                <div className="EmpOn_header">
                    <div className="top-bar">
                        <h2>
                            ...
                            All Travel list   <p>{currentEmployees.length} total</p>
                        </h2>
                        ...
                        <tbody>
                            {currentEmployees.map((emp, index) => (
                                <tr key={index}  >
                                    ...
                                    <td className='td' onClick={projectDetailsPage}>TRVL - 4{index}XYZ</td>
                                    <td onClick={projectDetailsPage}>Hillery Moses</td>
                                    <td>HSEQ</td>
                                    <td className='td' >Venice</td>
                                    <td className='td' >16-May-2024</td>
                                    <td className='td' >18-May-2024</td>
                                    <td >0{index+2}</td>
                                </tr>
                            ))}
                        </tbody>
