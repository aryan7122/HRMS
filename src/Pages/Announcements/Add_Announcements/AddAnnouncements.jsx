...
import FormAddAnnouncements from './FormAddAnnouncements.jsx';
import { useNavigate } from 'react-router-dom';
// import JobUpdateForm from '../UpdateJob/leaveForm'
        ...
        <>
            ...
            <div className="employee-form">
                <div className="top-bar">
                    <h2><div className='span'><HiUserPlus /></div>Add Announcement</h2>
                ...
                <div className="form-content">
                    <FormAddAnnouncements onSubmit={handleSubmit} />
