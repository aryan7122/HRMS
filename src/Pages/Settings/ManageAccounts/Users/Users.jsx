                            ...
                            <div className="_div_navigation_top">
                                <div className="reports-page-main">
                                    <div className="tabs-container-button tabs-container-button_">
                                        <button
                                            className={`tab-button-swich ${currentURL === '/settings/manage-accounts' ? 'active-swich_' : (firstWord == 'my') ? 'active-swich' : ''}`}
                                            onClick={() => handleTabClick('users') + navigate('/settings/manage-accounts')}
                                        >
                                            Users
                                        </button>
                                        <button
                                            className={`tab-button-swich ${currentURL === '/settings/manage-accounts/organization-setup' ? 'active-swich_' : (firstWord == 'organizational') ? 'active-swich' : ''}`}
