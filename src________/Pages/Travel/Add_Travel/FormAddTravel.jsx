                    ...
                    <div id='form'>
                        <div className="from1">
                            ...
                            <div className="form-group grupdate2">
                                <label htmlFor="" className='starred'>Expected date of arrival*</label>
                                <div className="dropdown-content date-h" id=''>
                                    <div className='date_tittle'>
                                        <div className='title__show__d'>
                                            {!selectedStartDate ? <span>Choose date of arrival</span> : selectedStartDate}
                                        </div>
                            ...
                            <div className="form-group grupdate2">
                                <label htmlFor="" className='starred'>Choose date of arrival</label>
                                <div className="dropdown-content date-h" id=''>
                                    <div className='date_tittle'>
                                        <div className='title__show__d'>
                                            {!selectedEndDate ? <span> Choose date of departure</span> : selectedEndDate}
                                        </div>
                                        <div className='date_icon'>
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#9b9b9b" fill="none">
                                                <path d="M18 2V4M6 2V4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div className="form-group">
                                ...
                                <input type="number" name="totalDays" placeholder='Choose date of departure' disabled value={formData.totalDays} onChange={handleChange} />
                            </div>
                            <div className="form-group">
