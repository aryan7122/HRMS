...
import FormAddTicket from './FormAddTicket.jsx';
import { useNavigate } from 'react-router-dom';
// import JobUpdateForm from '../../Recruitment/UpdateJob/JobUpdateForm';
        ...
        <>
            ...
            <div className="employee-form">
                <div className="top-bar">
                    <h2><div className='span'><HiUserPlus /></div>Add New Ticket</h2>
                ...
                <div className="form-content">
                    <FormAddTicket onSubmit={handleSubmit} />
