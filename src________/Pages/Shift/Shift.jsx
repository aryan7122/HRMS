...
const Shift = () => {
    ...
    const { isOpen: isFilterOpen4, ref: filterRef4, buttonRef: filterButtonRef4, handleToggle: toggleFilter4, setIsOpen: setFilterOpen } = OutsideClick();
                                    ...
                                    {weekDates.map((date, dateIndex) => {
                                        ...
                                        return (
                                            <td className='sift_td ' key={dateIndex} style={{
                                                backgroundColor: today === dateStr ? '#730fad0f' : 'transparent',
